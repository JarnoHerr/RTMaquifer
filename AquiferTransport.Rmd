...
abline(h=0.015, col="aquamarine4",lty = 2, lwd = 2)
...
abline(h=(25/62), col="cornflowerblue", lty=2, lwd = 2)

legend("topright", legend = c("minimal", "maximal", "well (200m)"), lty = 1, col = c("blue", "black", "green"))
