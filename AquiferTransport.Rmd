...
een mannetje en een vrouwtje gingen samen een filmpje kijken. Helaas is de film nooit gekeken. 
...
klooiparms["rA"]        <- 0.4
klooiparms["rD"]        <- 0.1
klooiparms["rAer"]      <- 0.00001
klooiparms["rNitri"]    <- 100
klooiparms["kO2"]       <- 0.1
...
for (DOMup in DOM_vect) 
   O2_vect2 <- c(O2_vect2, mean(Sens(DOMup)$y[,"O2"]))



plot(DOM_vect, O2_vect, type="b", xlab = "upstream DOM concentration, [molC/m3]", 
  ylab = "O2, [molO2/m3]", main = "O2 concentration in the aquifer", ylim = c(0,2), col = "blue")

lines(x = DOM_vect, y = O2_vect1, type = "b", col = "yellow")

lines(x = DOM_vect, y = O2_vect2, type = "b", col = "black")

legend("topright", legend = c("minimal", "maximal", "mean"), lty = 1, col = c("blue", "yellow", "black"))
...
for (DOMup in DOM_vect) 
   NO3_vect2 <- c(NO3_vect2, mean(Sens(DOMup)$y[,"NO3"]))

plot(DOM_vect, NO3_vect, type="b", xlab = "upstream DOM concentration, [molC/m3]", 
  ylab = "NO3, [molNO3/m3]", main = "NO3 concentration in the estuary", ylim = c(0,0.2), col = "blue")

lines(x = DOM_vect, y = NO3_vect1, type = "b", col ="yellow")

lines(x = DOM_vect, y = NO3_vect2, type = "b", col = "black")
...
for (DOMup in DOM_vect) 
   NH3_vect2 <- c(NH3_vect2, mean(Sens(DOMup)$y[,"NH3"]))

plot(DOM_vect, NH3_vect, type="b", xlab = "upstream DOM concentration, [molC/m3]", 
  ylab = "NH3, [molNH3/m3]", main = "NH3 concentration in the estuary", ylim = c(0, 0.03), col = "blue")

lines(x = DOM_vect, y = NH3_vect1, type = "b", col ="yellow")

lines(x = DOM_vect, y = NH3_vect2, type = "b", col = "black")
