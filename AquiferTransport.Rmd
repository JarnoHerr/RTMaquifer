...
## The data 
```{r}
(data.ext <- read.table(file = "p4-data.txt", header = TRUE, sep = ","))
(depth_data <- as.vector(data.ext$distance_m))
(ON_data <- as.vector(data.ext$ON_mM))
(O2_data <- as.vector(data.ext$O2_mM))
(NH4_data <- as.vector(data.ext$NH4_mM))
