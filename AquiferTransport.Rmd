...
legend("topright", legend = c("minimal", "maximal"), lty = 1, col = c("blue", "black"))
...
plot(DOM_vect, NO3_vect, type="b", xlab = "upstream DOM concentration, [molC/m3]", 
  ylab = "NO3, [molNO3/m3]", main = "NO3 concentration in the aquifer", ylim = c(0,0.4), col = "blue")
...
legend("topright", legend = c("minimal", "maximal", "well"), lty = 1, col = c("blue", "black", "green"))
